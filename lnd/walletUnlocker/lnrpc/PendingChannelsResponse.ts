...
export enum _lnrpc_PendingChannelsResponse_ForceClosedChannel_AnchorState {
  LIMBO = 0,
  RECOVERED = 1,
  LOST = 2,
}
...
export interface _lnrpc_PendingChannelsResponse_ClosedChannel__Output {
  'channel'?: (_lnrpc_PendingChannelsResponse_PendingChannel__Output);
  'closingTxid'?: (string);
}
...
export interface _lnrpc_PendingChannelsResponse_WaitingCloseChannel__Output {
  'channel'?: (_lnrpc_PendingChannelsResponse_PendingChannel__Output);
  'limboBalance'?: (Long);
  'commitments'?: (_lnrpc_PendingChannelsResponse_Commitments__Output);
}
