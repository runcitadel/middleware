...
export interface ChannelEventUpdate__Output {
  'openChannel'?: (_lnrpc_Channel__Output);
  'closedChannel'?: (_lnrpc_ChannelCloseSummary__Output);
  'activeChannel'?: (_lnrpc_ChannelPoint__Output);
  'inactiveChannel'?: (_lnrpc_ChannelPoint__Output);
  'type'?: (_lnrpc_ChannelEventUpdate_UpdateType);
  'pendingOpenChannel'?: (_lnrpc_PendingUpdate__Output);
}
