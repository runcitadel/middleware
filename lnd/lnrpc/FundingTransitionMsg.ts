...
export interface FundingTransitionMsg__Output {
  'shimRegister'?: (_lnrpc_FundingShim__Output);
  'shimCancel'?: (_lnrpc_FundingShimCancel__Output);
  'psbtVerify'?: (_lnrpc_FundingPsbtVerify__Output);
  'psbtFinalize'?: (_lnrpc_FundingPsbtFinalize__Output);
}
