...
export async function getTransaction(txid) {
    ...
    // @ts-expect-error
    let vintxid = Array.isArray(transactionObj.vin) ? transactionObj.vin[0].txid : transactionObj.vin.txid;
    let vouttx = Array.isArray(transactionObj.vout) ? transactionObj.vout[0] : transactionObj.vout;
    return {
        txid: txid,
