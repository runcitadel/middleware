...
router.get('/forwardingEvents', auth.jwt, safeHandler((req, res, next) => {
    ...
    return lightningLogic.getForwardingEvents(startTime, endTime, parseInt(indexOffset))
...
router.get('/invoices', auth.jwt, safeHandler((req, res) => lightningLogic.getInvoices()
...
router.get('/payments', auth.jwt, safeHandler((req, res) => lightningLogic.getPayments()
