...
router.get('/btc', auth.jwt, safeHandler((req: Request, res: Response) =>
...
router.post('/init', safeHandler((req: Request, res: Response) => {
...
router.get('/lightning', auth.jwt, safeHandler((req: Request, res: Response) =>
...
router.get('/seed', safeHandler((req: Request, res: Response) =>
